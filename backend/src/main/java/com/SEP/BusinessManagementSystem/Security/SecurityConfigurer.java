package com.SEP.BusinessManagementSystem.Security;
...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/requests/**").hasAnyAuthority("ROLE_SENIOR_CUSTOMER_SERVICE", "ROLE_FINANCIAL", "ROLE_ADMIN_MANAGER")
                .antMatchers("/events/**").authenticated()
                .antMatchers("/tasks/**").authenticated()
                .antMatchers("/subteams/**").hasAnyAuthority("ROLE_ADMIN_MANAGER")
